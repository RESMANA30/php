...
// 3. Input Tampilkan Konten
$input_display = readline(COLOR_BLUE . "3. Tampilkan konten yang diekstrak di layar? (y/n, default y): " . COLOR_RESET);
...
echo COLOR_GREEN . "\nSkrip berjalan dalam loop 10 detik. Tekan Ctrl + C untuk mengakhiri.\n\n" . COLOR_RESET; 

// ----------------------------------------------------
//             4. Loop Utama (Berjalan terus-menerus)
// ----------------------------------------------------
...
while (true) {
    ...
    if ($elements->length > 0) {
        ...
        // 5. Deteksi Perubahan dan BUNYIKAN PERINGATAN
